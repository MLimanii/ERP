...
.menu_contenu.menu_contenu_societe_card {
  background: var(--butactionbg);
  margin: 10px 0;
  border-radius: 5px;
  text-align: center;
...
.menu_contenu.menu_contenu_societe_card a {
  color: #fff !important;
  text-transform: uppercase;
  font-weight: bold;
}
.menu_contenu.menu_contenu_societe_list {
  background: var(--colortexttitlenotab);
  margin-bottom: 10px ;
  border-radius: 5px;
  text-align: center;
...
.menu_contenu.menu_contenu_societe_list    a {
  color: #fff !important;
  text-transform: uppercase;
  font-weight: bold;
}
...
div.inner_create_new_client {
  ...
  div.inner_create_new_client a {
    margin-right: 30px;
  }

  div.inner_create_new_client a:hover {
    text-decoration: none;
  }
...
button.newButton.btn-fizicko {
  background: var(--butactionbg);
}

button.newButton.btn-privatno {
  background: var(--colortexttitlenotab);
}
div.btn-icons {
  font-size: 20px;
