...
if (empty($reshook)) {
    ...
    $middlename = GETPOST("middlename", 'alphanohtml');
    ...
    if ($morphy != 'mor' && empty($middlename)) {
      $error++;
      $langs->load("errors");
      setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Middlename")), null, 'errors');
    }
      ...
      $object->middlename  = trim(GETPOST("middlename", 'alphanohtml'));
...
if (is_object($objcanvas) && $objcanvas->displayCanvasExists($action)) {
    ...
    // Middlename
    print '<tr><td id="tdlastname">'.$langs->trans("Middlename").'</td><td><input type="text" name="middlename" class="minwidth300" maxlength="50" value="'.(GETPOSTISSET('middlename') ? GETPOST('middlename', 'alphanohtml') : $object->middlename).'"></td>';
    print '</tr>';
    ...
    // Middlename
    print '<tr><td id="tdlastname">'.$langs->trans("Middlename").'</td><td><input type="text" name="middlename" class="minwidth300" maxlength="50" value="'.(GETPOSTISSET("middlename") ? GETPOST("middlename", 'alphanohtml', 2) : $object->middlename).'"></td>';
    print '</tr>';
