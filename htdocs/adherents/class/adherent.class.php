...
class Adherent extends CommonObject
{
    ...
    'middlename' => array('type' => 'varchar(50)', 'label' => 'Middlename', 'enabled' => 1, 'visible' => -1, 'position' => 30, 'showoncombobox'=>1),
    ...
    $infos .= $langs->transnoentities("Middlename").": ".$this->middlename."\n";
      ...
      '__MIDDLENAME__' => $msgishtml ? dol_htmlentitiesbr($this->middlename) : ($this->middlename ? $this->middlename : ''),
    ...
    $this->middlename = trim($this->middlename) ? trim($this->middlename) : trim($this->middlename);
    ...
    $sql .= ", middlename = ".($this->middlename ? "'".$this->db->escape($this->middlename)."'" : "null");
		...
		if ($resql) {
            ...
            $luser->middlename = $this->middlename;
	...
	public function fetch($rowid, $ref = '', $fk_soc = '', $ref_ext = '', $fetch_optionals = true, $fetch_subscriptions = true)
	{
		...
		$sql = "SELECT d.rowid, d.ref, d.ref_ext, d.civility as civility_code, d.gender, d.firstname, d.middlename, d.lastname,";
    ...
    $this->middlename= 'MIDDLE DOLIBARR';
