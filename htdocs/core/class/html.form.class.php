...
class Form
{
	...
	public function showrefnav($object, $paramid, $morehtml = '', $shownav = 1, $fieldid = 'rowid', $fieldref = 'ref', $morehtmlref = '', $moreparam = '', $nodbprefix = 0, $morehtmlleft = '', $morehtmlstatus = '', $morehtmlright = '')
	{
      ...
      $stringCheck = $object->name;
      $ret .= dol_htmlentities(getCyrillic($stringCheck)) . "<br /> ";
      $ret .= dol_htmlentities(getLattin($stringCheck));
			...
			$ret .= $object->ref.'<br>';
			$fullname = getCyrillic($object->getFullName($langs));
